      ...
      {items.map(({ to, label, icon: Icon, end }) => {
        const link = (
          ...
          <NavLink
            ...
            aria-label={label}
            className={cn(
              "flex min-h-11 items-center gap-3 overflow-hidden rounded-lg px-3 py-2 text-[0.9375rem] font-medium transition-[background-color,color,padding] duration-300 ease-in-out",
